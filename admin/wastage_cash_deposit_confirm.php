...
<h4 class="text-center alert alert-info  ">Confirm Wastage Cash Receive!</h4>
...
?>
			<form class="form-horizontal col-md-8 col-md-offset-1" action="wastage_cash_deposit_insert.php" method="POST">
			  ...
			  <button type="submit" name="submit" class="btn btn-primary next">Confirm</button>
			</div>
