...
<div class="container-fluid">
		<h4 class="text-center heading-color">Add Employee Info</h4>
		<?php 
...
?>
		<form class="form-horizontal col-md-6 col-md-offset-2" action="add_employee_manualy_insert.php" method="POST">
	  <div class="form-group">
		<label for="employee_full_name" class="col-sm-4 control-label">Employee Full Name</label>
		<div class="col-sm-8">
