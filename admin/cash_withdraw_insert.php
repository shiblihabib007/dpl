...
$amount=$_SESSION['amount'];
				...
				//echo $amount." ".$bank_old_balance;
					...
					//report insert start
					$sql_report = "INSERT INTO reports (report_transection_status,report_bank_cash_or_cheque_withdraw_amount,report_cash_old_balance,report_cash_new_balance )
						VALUES ('cash withdraw','$amount','$bank_old_balance','$bank_balance')";
					$conn->query($sql_report);
					//report insert end
					
					$_SESSION["Cash_success_msg"]="Cash Successfully withdrawn ";
