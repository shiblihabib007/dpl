...
$sql="SELECT * FROM reports WHERE report_transection_status='cash withdraw' and report_transection_date BETWEEN '$start_date' AND '$end_date'";
$result = mysqli_query($conn, $sql);

	if (mysqli_num_rows($result) > 0) {
		
	?>
<h4 class="text-center alert alert-success ">Cash Withdraw Transactions during this period !</h4>
...
<form action="report_cash_withdraw.php" method="post">
