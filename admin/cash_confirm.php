...
<h4 class="text-center alert alert-info  ">Confirm Cash Deposit!</h4>
...
?>
			<form class="form-horizontal col-md-8 col-md-offset-1" action="cash_deposit_insert.php" method="POST">
