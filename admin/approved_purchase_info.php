...
<?php require 'nav.php';?>
<div class="container">
<h4 class="text-center alert alert-info"> Approved Purchase !</h4>
		<form action=""  >
		 <div class="form-group">
			<label for="exampleFormControlSelect1" >Purchase Internal Bill No.</label>
			<input type="text" name="purchase_bill_no" class="form-control" value="<?php echo $purchase_bill_no; ?>" disabled>
			</br>
			<label for="exampleFormControlSelect1">Supplier Name</label>
			<input type="text" name="supplier_info" class="form-control" value="<?php echo $supplier_name; ?>" disabled>
