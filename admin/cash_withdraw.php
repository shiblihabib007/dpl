...
<h4 class="text-center alert alert-info  ">Cash Withdraw!</h4>
...
?>
			...
			<form class="form-horizontal col-md-8 col-md-offset-1" action="cash_withdraw_confirm.php" method="POST">
