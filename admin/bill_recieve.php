...
if(isset($_POST['submit']) and isset($_POST['check_list'])){
	...
	$_SESSION["final_cheque_no"]=null;
	$_SESSION["final_cheque_amount"]=null;	
	$_SESSION["total_dues"]=null;
	$_SESSION["account_number"]=null;
	$_SESSION["acc_bank_acc_balance"]=null;
	...
	<form action="bill_recieve_insert.php" method="post" enctype="multipart/form-data">
	<div class="form-group col-md-5 col-md-offset-2">
	
		<label for="exampleFormControlSelect1"  >Cheque Number</label>
		<input type="text"  class="form-control" value="<?php echo $cheque_no; ?>"   disabled>
		</br>
	...
	//echo "--------------------------";
		...
		<tr>
			...
			<td><td>
			<td><b>Total=</b></td>
			<td><input type="text" name="total_due" value="<?php echo $total_dues1;?>"> <td>
			<td></td>
		</tr>
		<tr>
			<td></td>
	  ...
	  <tr>
	   <td></td>
        ...
        <td><input type="text" name="due[]" value="<?php echo $amount_of_taka_of_cheque;?>"> <td>
		...
		<?php
		if($amount_of_taka_of_cheque < $total_due_after_count_both_vat){
			$grace_amount= $total_due_after_count_both_vat - $amount_of_taka_of_cheque;
			?>
			<tr>
	   <td></td>
		<td> <td>
		...
		<td ><b>grace / Due Amount=</b></td>
			<td><input type="text" name="grace_or_due" value="<?php echo $grace_amount;?>"> <td>
			<td></td>
		</tr>
...
?>
  <button class="btn btn-default btn-primary" name="submit"> Confirm</button>
	...
	$_SESSION["final_cheque_no"]=$cheque_no;
	$_SESSION["final_cheque_amount"]=$amount_of_taka_of_cheque;	
	$_SESSION["total_dues"]=$total_dues1;
	$_SESSION["account_number"]=$bank_account_number;
	$_SESSION["acc_bank_acc_balance"]=$acc_bank_acc_balance;
	$_SESSION["net_vat"]=$net_vat;
	$_SESSION["grand_total_after_adjust_vat"]=$total_due_after_count_both_vat;
	$_SESSION["grace_or_due"]=$grace_amount;
