...
<h4 class="text-center alert alert-info  ">Wastage Cash Receive!</h4>
...
?>
			...
			<form class="form-horizontal col-md-8 col-md-offset-1" action="wastage_cash_deposit_confirm.php" method="POST">
